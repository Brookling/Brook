        ...
        Joker={
            j_broo_stargaze={
                ...
                text = {
                    ...
                    "{C:attention}#1#{} by {C:attention}#2# levels{},",
                    "poker hand changes",
                    "after each play",
                },
            },
            ...
            j_broo_yeast={
                ...
                text = {
                    ...
                    "at end of round",
                    "The amount increases by {X:mult,C:white} X#3# {}",
            ...
            j_broo_pulp_fiction={
                name = 'Pulp Fiction',
                text = {
                    "Discarded {C:attention}2s{}, {C:attention}3s{}, {C:attention}4s{} or {C:attention}5s{}",
                    "no longer return to",
                    "{C:attention}deck{} until this card",
        ...
        Mod={
            Brook={
                ...
                text = {
                    ...
                    " ",
                    "{C:green}Thanks to{}",
                    "Snowlight, mleaf233, 280chan,",
                    "Seastar, 22461 and Marffe",
                    " ",
            ...
            About={
                ...
                text = {
                    ...
                    " ",
                    "{C:attention}From February to August 2025{}, I dedicated myself to creating a {C:blue}high-quality{},",
                    "{C:blue}vanilla-like{} mod, drawing a lot of inspiration from many existing mods and feeling deeply",
